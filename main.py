...
from train_grap import Trainer_for_grap
...
if __name__ == '__main__':
    ...
    #.add_argument('--config',default='./experiments/KINS/pcnet_m/config.yaml', type=str)
    parser.add_argument('--config', default='./experiments/Grap/new_experiment/config.yaml', type=str)
    parser.add_argument('--launcher', default='pytorch', type=str)
    parser.add_argument('--load-iter', default=None, type=int)
    parser.add_argument('--load-pretrain', type=str)
